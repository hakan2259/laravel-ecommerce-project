                ...
                <form method="post" action="{{url('update/product/withoutphoto/'.$product->id)}}">
                    ...
                    <div class="form-layout">
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Discunt Price: <span
                                            class="tx-danger">*</span></label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input id="color" type="text" data-role="tagsinput" class="form-control"
                                           name="product_color" value="{{$product->product_color}}"/>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           name="video_link" placeholder="Video Link" value="{{$product->video_link}}"/>
                ...
                <div class="card pd-20 pd-sm-40">
                    ...
                    <form method="post" action="{{url('update/product/photo/'.$product->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <img src="{{URL::to($product->image_three)}}" style="width: 80px; height:80px;" alt="{{$product->product_name}}"/>
