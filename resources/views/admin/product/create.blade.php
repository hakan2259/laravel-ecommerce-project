                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Size: <span
                                            class="tx-danger">*</span></label>
                                    <input id="size" type="text" data-role="tagsinput" class="form-control"
                                           name="product_size"/>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Product Color: <span
                                            class="tx-danger">*</span></label>
                                    <input id="color" type="text" data-role="tagsinput" class="form-control"
                                           name="product_color"/>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Selling Price: <span
                                            class="tx-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Selling Place"
                                           name="selling_price"/>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_one" onchange="readURL(this);" required="required">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Image Two: <span
                                            class="tx-danger">*</span></label>
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL2(this);" required="required">
                                        <span class="custom-file-control"></span>
                                        <img src="#" id="two">
                                    </label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label">Image Three: <span
                                            class="tx-danger">*</span></label>
                                    <label class="custom-file">
                                        <input type="file" id="file" class="custom-file-input" name="image_three" onchange="readURL3(this);" required="required">
                                        <span class="custom-file-control"></span>
                                        <img src="#" id="three">
                                    </label>
