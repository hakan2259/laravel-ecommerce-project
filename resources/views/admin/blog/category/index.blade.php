                        ...
                        @foreach($blogcat as $key=>$row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('delete/blogcategory/'.$row->id)}}" class="btn btn-sm btn-danger"
                                       id="delete">Delete</a>
                                </td>
                    ...
                    <form action="{{route('store.blog.category')}}" method="post">
                        ...
                        <div class="modal-body pd-20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category_name_de" placeholder="Category Name Germany">
